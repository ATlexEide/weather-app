...
#submit-location {
    height: var(--location-input-height);
    aspect-ratio: 5/2;
}`, "",{"version":3,"sources":["webpack://./src/css/style.css"],"names":[],"mappings":"AAAA;IACI,6BAA6B;IAC7B,0BAA0B;IAC1B,2CAA2C;IAC3C,oBAAoB;AACxB;;AAEA;IACI,mJAAmJ;IACnJ,YAAY;IACZ,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,yDAA+C;IAC/C,qBAAqB;IACrB,SAAS;IACT,aAAa;AACjB;;AAEA;IACI,YAAY;IACZ,YAAY;IACZ,eAAe;IACf,yCAAyC;;AAE7C;;AAEA;IACI,gBAAgB;IAChB,UAAU;IACV,YAAY;IACZ,kBAAkB;AACtB;;AAEA;IACI,kBAAkB;IAClB,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,YAAY;IACZ,aAAa;IACb,yCAAyC;AAC7C;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,WAAW;IACX,UAAU;IACV,mBAAmB;IACnB,yCAAyC;AAC7C;;AAEA;IACI,mBAAmB;IACnB,YAAY;AAChB;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,iBAAiB;IACjB,mBAAmB;IACnB,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,YAAY;IACZ,sBAAsB;IACtB,8BAA8B;AAClC;;;AAGA;IACI,eAAe;AACnB;;AAEA;IACI,eAAe;IACf,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,mBAAmB;AACvB;;AAEA;IACI,eAAe;IACf,0BAA0B;IAC1B,mBAAmB;AACvB;;AAEA;IACI,kBAAkB;IAClB,WAAW;IACX,0BAA0B;;AAE9B;;;AAGA;IACI,kBAAkB;IAClB,UAAU;IACV,0BAA0B;AAC9B;;AAEA;IACI,0BAA0B;IAC1B,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,iBAAiB;IACjB,aAAa;IACb,sBAAsB;IACtB,kBAAkB;IAClB,8BAA8B;IAC9B,UAAU;IACV,WAAW;IACX,gBAAgB;IAChB,aAAa;IACb,sCAAsC;IACtC,mBAAmB;AACvB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,wJAAwJ;IACxJ,oBAAoB;IACpB,WAAW;AACf;;AAEA;IACI,eAAe;IACf,gBAAgB;AACpB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,WAAW;IACX,uBAAuB;IACvB,mBAAmB;IACnB,mCAAmC;AACvC;;AAEA;IACI,aAAa;AACjB;;AAEA;;IAEI,aAAa;IACb,sBAAsB;IACtB,WAAW;AACf;;AAEA;IACI,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,mBAAmB;IACnB,uBAAuB;IACvB,eAAe;AACnB;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,iBAAiB;IACjB,mBAAmB;IACnB,iBAAiB;IACjB,WAAW;AACf;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,gBAAgB;IAChB,iBAAiB;IACjB,YAAY;IACZ,uCAAuC;;AAE3C;;AAEA;IACI,yBAAyB;AAC7B;;;AAGA;IACI,oCAAoC;IACpC,YAAY;AAChB;;AAEA;IACI,oCAAoC;IACpC,iBAAiB;AACrB","sourcesContent":[":root {\n    --location-input-height: 24px;\n    --info-side-padding: 550px;\n    --background-color: rgb(111, 183, 247, 0.2);\n    --compass-size: 75px;\n}\n\n* {\n    font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n    margin: none;\n    padding: none;\n}\n\nbody {\n    display: flex;\n    flex-direction: column;\n    background-image: url('../images/backdrop.jpg');\n    background-size: 100%;\n    margin: 0;\n    height: 100vh;\n}\n\nheader {\n    height: 94px;\n    width: 100vw;\n    font-size: 26px;\n    background-color: var(--background-color);\n\n}\n\nh1 {\n    margin-top: 12px;\n    padding: 0;\n    color: black;\n    text-align: center;\n}\n\n#main-container {\n    place-self: center;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    width: 100vw;\n    height: 100vh;\n    background-color: var(--background-color);\n}\n\n#info-container {\n    display: flex;\n    align-items: center;\n    flex: 3 1 0;\n    width: 75%;\n    align-items: center;\n    /* padding: 0 var(--info-side-padding); */\n}\n\n#info-container>* {\n    width: calc(100%/3);\n    height: 100%;\n}\n\n#weather-icon {\n    width: 150px;\n}\n\n#condition-text {\n    margin-top: -20px;\n    margin-bottom: 20px;\n    font-size: 38px;\n}\n\n#city-info {\n    display: flex;\n    height: 100%;\n    flex-direction: column;\n    justify-content: space-between;\n}\n\n\n.city-details {\n    font-size: 58px;\n}\n\n#country {\n    font-size: 34px;\n    margin-bottom: 4px;\n}\n\n#weather-conditions {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    margin-bottom: auto;\n}\n\n#compass-container {\n    aspect-ratio: 1;\n    width: var(--compass-size);\n    margin-bottom: auto;\n}\n\n#compass-body {\n    position: absolute;\n    opacity: .3;\n    width: var(--compass-size);\n\n}\n\n\n#wind-dir-icon {\n    position: relative;\n    z-index: 1;\n    width: var(--compass-size);\n}\n\n#compass-wind-dir-text {\n    width: var(--compass-size);\n    text-align: center;\n    font-size: 28px;\n}\n\n#weather-info {\n    margin-left: auto;\n    display: flex;\n    flex-direction: column;\n    align-items: start;\n    justify-content: space-between;\n    width: 45%;\n    height: 93%;\n    margin-right: 3%;\n    padding: 20px;\n    background-color: rgb(51, 48, 202, .2);\n    border-radius: 20px;\n}\n\n.weather-details {\n    font-size: 20px;\n}\n\n#graph {\n    background-image: url(https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Pushkin_population_history.svg/400px-Pushkin_population_history.svg.png);\n    height: calc(100%/2);\n    width: 100%;\n}\n\n#day-0 {\n    font-size: 20px;\n    font-weight: 500;\n}\n\n#input-container {\n    display: flex;\n    flex-direction: column-reverse;\n    flex: 1 1 0;\n    justify-content: center;\n    align-items: center;\n    padding: 0 var(--info-side-padding);\n}\n\n#radio-container {\n    display: flex;\n}\n\n#radio-celcius,\n#radio-fahrenheit {\n    display: flex;\n    flex-direction: column;\n    margin: 8px;\n}\n\n#ch-bar {\n    display: flex;\n    align-items: center;\n}\n\ninput {\n    border-radius: 25px;\n    border: 1px solid black;\n    padding: 0 10px;\n}\n\ninput::placeholder {\n    margin-left: 20px;\n}\n\nbutton {\n    margin-left: 10px;\n    border-radius: 15px;\n    border: solid 1px;\n    width: 75px;\n}\n\nfooter {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    margin-top: auto;\n    padding-top: auto;\n    height: 2rem;\n    background-color: rgba(34, 65, 92, 0.4);\n\n}\n\n#link-back {\n    color: rgb(176, 175, 241);\n}\n\n\n#input-location {\n    height: var(--location-input-height);\n    width: 150px;\n}\n\n#submit-location {\n    height: var(--location-input-height);\n    aspect-ratio: 5/2;\n}"],"sourceRoot":""}]);
// Exports
